...
test_data_dir = os.path.join(temp_dir, "test.jsonl")
...
ds=load_dataset('sarus-tech/medical_few_diseases',token=os.getenv('HF_TOKEN'))['train']
ds=ds.train_test_split(train_size=2300,seed=10)
